ig.module(
	...
	.defines(function () {
		...
		jQuery.getJSON("https://webtechlecture.appspot.com/highscore/list?gamename=ducccc", (highscore) => {
		...
		EnterHighscore = ig.Game.extend({
			...
			update: function () {
				if (ig.input.pressed("enter")) {
					...
					let requestUrl = "https://webtechlecture.appspot.com/highscore/add?gamename=ducccc&playername=" + this.nameDrawn + "&points=" + score;
